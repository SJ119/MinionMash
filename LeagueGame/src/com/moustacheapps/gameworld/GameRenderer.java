...
//
//	// Game Assets
//	private TextureRegion mountain, mountain2, mountainf, mountainf2, cloud1, cloud1f, cloud2,
...
//
//	public Rectangle scissorsLeft, scissorsRight, scissorsFull, left, right, full, grassScissorsRight, grassScissorsLeft;
//
...
//		mountain2 = AssetLoader.mountain;
//		mountainf = AssetLoader.mountainf;
//		mountainf2 = AssetLoader.mountainf;
...
//		drawStuff(mountain2, mountainScroll2);
//		drawPipe(pipe1);
//		drawPipe(pipe2);
//		drawPipe(pipe3);
//		drawPipeTip(pipe1);
...
//		drawStuff(mountainf2, mountainfScroll2);
//		drawPipe(pipeA);
//		drawPipe(pipeB);
//		drawPipe(pipeC);
//		drawPipeTip(pipeA);
...
//
//		ScissorStack.calculateScissors(cam, 0, 0, screenWidth, screenHeight,
//				batcher.getTransformMatrix(), full, scissorsFull);
//		ScissorStack.pushScissors(scissorsFull);
//		batcher.flush();
//		drawPowerUp();
